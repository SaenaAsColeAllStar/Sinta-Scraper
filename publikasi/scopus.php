...
<div class="card-custom">
    <div class="card-header-custom">
        <h5><i class="bi bi-journal-bookmark-fill me-2"></i>Publikasi Scopus</h5>
        <div class="d-flex gap-2 flex-wrap align-items-center">
            ...
            <a href="<?= $base_url ?>/export/export_excel.php?type=scopus&dosen_id=<?= $dosen_id ?>" class="btn btn-success-custom btn-sm-custom">
...
function loadData(page) {
    ...
    $('a[href*="export_excel"]').attr('href', '{$base_url}/export/export_excel.php?type=scopus&dosen_id=' + dosenId);
    
    loadPagination('{$base_url}/ajax/pagination_scopus.php', 'dataContainer', page, perPage, dosenId, { keyword: keyword });
}
